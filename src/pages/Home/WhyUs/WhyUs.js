          ...
          <div className={styles.right}>
            <div className={styles.upper}>
              ...
              <div className={styles.upperRight}>
                <p>
                  We are capable to produce 6000 MT aluminum profile annually, powered by advancedextrusion presses an in-house billetcasting. It reflects our commitment to high-volume, precision-driven manufacturing.
                </p>
                <h1>6000 MT</h1>
              </div>
            </div>
